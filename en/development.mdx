...
After connecting to the Gemstone development board via [Serial port](./quickstart#21-serial-port),
[SSH](./quickstart#23-ssh-connection-over-the-network), or
[VNC](./quickstart#22-vnc-remote-desktop-connection-via-browser), apply the following steps.
</Tip>
